        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cwd = process.cwd();
                    return [4 /*yield*/, fs_1.promises.mkdir(cwd + "/scripts/" + name, {
                            recursive: true
                        })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, template_1.generateFile('script', {}, path_1["default"].resolve(cwd, "scripts/" + name + ".js"))];
                case 2:
                    _a.sent();
