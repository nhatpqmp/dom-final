...
function makeReducer(name) {
    return __awaiter(this, void 0, void 0, function () {
        var spinner, cwd, writingFilePath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cwd = process.cwd();
                    writingFilePath = path_1["default"].resolve(cwd, "packages/assets/src/reducers/" + name + "Reducer.js");
                    return [4 /*yield*/, template_1.generateFile('reducer', {
                            name: name
                        }, writingFilePath)];
                case 1:
                    _a.sent();
