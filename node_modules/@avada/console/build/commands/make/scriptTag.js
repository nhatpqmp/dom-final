        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_extra_1["default"].copy(path_1["default"].resolve(__dirname, '../../../storage/scriptTag'), cwd + "/packages/scripttag")];
                case 1:
                    _a.sent();
                    spinner.start('Installing all dependencies');
                    asyncExec = util_1.promisify(child_process_1.exec);
                    return [4 /*yield*/, asyncExec('yarn install', { cwd: cwd })];
                case 2:
                    _a.sent();
