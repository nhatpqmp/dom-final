...
var credentials_1 = require("../../helpers/credentials");
 ...
 */
function exportFirestore(collection, options) {
    return __awaiter(this, void 0, void 0, function () {
        var spinner, fileName, items, i, doc, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spinner = ora_1["default"]('').start();
                    spinner.info("Exporting Firestore for collection: " + collection);
                    return [4 /*yield*/, credentials_1.setupCredentials(spinner, options.credentials)];
                case 1:
                    _a.sent();
                    fileName = options.file || "export_" + collection + "}";
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < items.size)) return [3 /*break*/, 8];
                    doc = items.docs[i];
                    _a.label = 4;
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, fs_1.promises.writeFile(fileName + ".json", JSON.stringify(doc))];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 6:
...
exports["default"] = exportFirestore;
